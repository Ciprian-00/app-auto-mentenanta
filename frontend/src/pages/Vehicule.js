  ...
  if (loading) {
    return (
      <div style={s.loadingWrap}>
        ...
        <p style={{ color: '#00e5ff', letterSpacing: '2px', fontSize: '0.85rem', marginTop: '1rem' }}>INIȚIALIZARE SISTEM...</p>
      </div>
    );
  }
...
const s = {
  pagina: { backgroundColor: '#0b0e14', color: '#fff', minHeight: '100vh', fontFamily: '"Inter", sans-serif', paddingBottom: 'calc(80px + env(safe-area-inset-bottom))', paddingTop: '80px' },
  ...
  navbar: { position: 'fixed', top: 0, left: 0, right: 0, zIndex: 40, backgroundColor: 'rgba(11,14,20,0.85)', backdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(255,255,255,0.05)', padding: '14px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  navLeft: { display: 'flex', alignItems: 'center', gap: '12px' },
  backBtn: { background: 'none', border: 'none', color: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4px' },
  navTitlu: { fontSize: '1rem', fontWeight: '800', letterSpacing: '1px', color: '#fff' },
  addBtn: { backgroundColor: '#00e5ff', color: '#001f24', padding: '9px 16px', borderRadius: '8px', fontWeight: '800', fontSize: '0.75rem', letterSpacing: '1px', border: 'none', cursor: 'pointer', boxShadow: '0 4px 15px rgba(0,229,255,0.2)' },
  ...
  golText: { color: '#64748b', margin: 0, fontSize: '0.9rem' },

  card: { backgroundColor: '#13161f', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '14px', overflow: 'hidden', cursor: 'pointer', display: 'flex', flexDirection: 'column', boxShadow: '0 8px 24px rgba(0,0,0,0.4)' },
  cardHeader: { position: 'relative', height: '160px', background: 'linear-gradient(180deg, #0f1524 0%, #080b12 100%)', display: 'flex', alignItems: 'flex-end', padding: '14px', overflow: 'hidden' },
  brandWatermark: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '4.5rem', fontWeight: '900', color: 'rgba(255,255,255,0.03)', letterSpacing: '6px', userSelect: 'none', whiteSpace: 'nowrap', pointerEvents: 'none' },
  statusBadge: { position: 'absolute', top: '14px', left: '14px', backgroundColor: 'rgba(0,0,0,0.55)', border: '1px solid rgba(255,255,255,0.08)', color: '#fff', padding: '5px 11px', borderRadius: '20px', fontSize: '9px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1px', display: 'flex', alignItems: 'center', gap: '6px', backdropFilter: 'blur(6px)', zIndex: 3 },
  ...
  iconBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.55)', border: '1px solid rgba(255,255,255,0.08)', color: '#fff', borderRadius: '8px', width: '32px', height: '32px', cursor: 'pointer', backdropFilter: 'blur(6px)', padding: 0, boxSizing: 'border-box', lineHeight: 0 },
  placuta: { position: 'absolute', bottom: '14px', left: '14px', display: 'inline-flex', alignItems: 'center', border: '2px solid rgba(255,255,255,0.12)', borderRadius: '5px', overflow: 'hidden', zIndex: 3 },
  ...
  cardBody: { padding: '18px', display: 'flex', flexDirection: 'column', gap: '14px', backgroundColor: '#13161f' },
  carNume: { fontSize: '1.15rem', fontWeight: '800', margin: '0 0 4px 0', color: '#fff' },
  carSub: { fontSize: '0.65rem', color: '#64748b', textTransform: 'uppercase', letterSpacing: '1.5px', margin: 0, fontWeight: '700' },
  statsRow: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' },
  statBox: { backgroundColor: '#1a1d27', border: '1px solid rgba(255,255,255,0.04)', padding: '11px 12px', borderRadius: '9px', display: 'flex', flexDirection: 'column', gap: '4px' },
  statLabel: { fontSize: '0.6rem', color: '#64748b', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: '700' },
  statVal: { fontSize: '1rem', fontWeight: '800', color: '#fff' },
  statUnit: { fontSize: '0.65rem', color: '#94a3b8', fontWeight: '400', textTransform: 'uppercase' },
  docsRow: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px', paddingTop: '14px', borderTop: '1px solid rgba(255,255,255,0.05)' },
  docItem: { display: 'flex', flexDirection: 'column', gap: '3px' },
  docLabel: { fontSize: '0.58rem', color: '#64748b', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: '700' },
  ...
  modal: { background: 'linear-gradient(180deg, #13161f 0%, #0b0e14 100%)', width: '100%', maxWidth: '500px', padding: '24px', borderRadius: '15px', border: '1px solid rgba(0,229,255,0.25)', maxHeight: 'calc(85vh - env(safe-area-inset-top) - env(safe-area-inset-bottom))', overflowY: 'auto' },
  modalHeader: { position: 'sticky', top: 0, zIndex: 1, background: 'linear-gradient(180deg, #13161f 80%, transparent 100%)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '16px', marginBottom: '4px' },
  modalTitlu: { fontSize: '0.85rem', fontWeight: '800', color: '#00e5ff', letterSpacing: '1.5px', margin: 0 },
  closeBtn: { background: 'none', border: 'none', color: '#94a3b8', fontSize: '1.3rem', cursor: 'pointer', lineHeight: 1 },
  form: { display: 'flex', flexDirection: 'column', gap: '14px' },
  formRow: { display: 'flex', gap: '14px' },
  field: { flex: 1, display: 'flex', flexDirection: 'column', gap: '5px' },
  label: { fontSize: '0.65rem', color: '#00e5ff', fontWeight: '800', letterSpacing: '1px' },
  input: { backgroundColor: '#0b0e14', border: '1px solid rgba(255,255,255,0.08)', padding: '11px 13px', borderRadius: '8px', color: '#fff', outline: 'none', fontSize: '0.875rem', width: '100%', boxSizing: 'border-box' },
  dateInput: { backgroundColor: '#0b0e14', border: '1px solid rgba(255,255,255,0.08)', padding: '11px 13px', borderRadius: '8px', color: '#fff', outline: 'none', fontSize: '0.875rem', colorScheme: 'dark', width: '100%', boxSizing: 'border-box' },
  divider: { textAlign: 'center', fontSize: '0.6rem', color: '#00e5ff', margin: '8px 0 2px 0', letterSpacing: '2px', fontWeight: '800' },
  ...
  saveBtn: { backgroundColor: '#00e5ff', color: '#001f24', padding: '14px', border: 'none', borderRadius: '8px', fontWeight: '800', fontSize: '0.8rem', letterSpacing: '1px', cursor: 'pointer', marginTop: '6px', width: '100%' },
};
