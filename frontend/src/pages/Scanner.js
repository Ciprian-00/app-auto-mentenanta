...
const s = {
  ...
  resetBtn: { background: 'none', border: '1px solid rgba(255,255,255,0.12)', color: '#94a3b8', padding: '7px 14px', borderRadius: '8px', fontSize: '0.7rem', fontWeight: '700', letterSpacing: '1px', cursor: 'pointer' },
  main: { padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' },

  dropZone: { border: '2px dashed rgba(0,229,255,0.2)', borderRadius: '14px', backgroundColor: '#13161f', minHeight: '220px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', overflow: 'hidden' },
  ...
  btnSecundar: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', backgroundColor: '#13161f', border: '1px solid rgba(255,255,255,0.08)', color: '#94a3b8', padding: '13px', borderRadius: '10px', fontSize: '0.8rem', fontWeight: '700', cursor: 'pointer' },
  btnPrincipal: { width: '100%', backgroundColor: '#00e5ff', color: '#001f24', padding: '15px', border: 'none', borderRadius: '10px', fontWeight: '800', fontSize: '0.85rem', letterSpacing: '1px', cursor: 'pointer', boxShadow: '0 4px 20px rgba(0,229,255,0.25)' },

  legenda: { backgroundColor: '#13161f', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '12px', padding: '16px' },
  ...
  legendaCod: { backgroundColor: 'rgba(0,229,255,0.08)', border: '1px solid rgba(0,229,255,0.2)', color: '#00e5ff', fontSize: '0.65rem', fontWeight: '800', padding: '2px 7px', borderRadius: '5px', minWidth: '30px', textAlign: 'center' },
  legendaDesc: { color: '#94a3b8', fontSize: '0.72rem' },

  loadingBox: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', padding: '3rem 2rem', backgroundColor: '#13161f', borderRadius: '14px', border: '1px solid rgba(255,255,255,0.05)' },
  spinner: { width: '40px', height: '40px', border: '3px solid rgba(0,229,255,0.15)', borderTop: '3px solid #00e5ff', borderRadius: '50%', animation: 'spin 0.9s linear infinite' },
  ...
  infoBanner: { display: 'flex', alignItems: 'center', gap: '10px', backgroundColor: 'rgba(0,229,255,0.06)', border: '1px solid rgba(0,229,255,0.15)', borderRadius: '10px', padding: '12px 14px', fontSize: '0.78rem', color: '#94a3b8', lineHeight: 1.5 },
