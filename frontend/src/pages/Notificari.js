        ...
        {TABS.map(tab => {
          ...
          return (
            <button key={tab.key} onClick={() => setTabActiv(tab.key)}
              ...
              {tab.label}
              <span style={{ ...s.tabCount, background: activ ? 'rgba(0,229,255,0.15)' : 'var(--border-soft)', color: activ ? 'var(--accent)' : 'var(--text-faint)' }}>
                {count}
              </span>
            </button>
          );
...
const s = {
  ...
  header: { padding: '20px 18px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-soft)', backgroundColor: 'var(--nav-bg)', position: 'sticky', top: 0, zIndex: 40, backdropFilter: 'blur(16px)' },
  headerSub: { margin: '0 0 2px 0', color: 'var(--text-dim)', fontSize: '9px', letterSpacing: '2px', fontWeight: '700' },
  headerTitlu: { margin: 0, color: 'var(--text)', fontSize: '20px', fontWeight: '800', letterSpacing: '-0.3px' },
  ...
  tabsWrap: { display: 'flex', gap: '6px', padding: '12px 16px', overflowX: 'auto', borderBottom: '1px solid var(--border-soft)', scrollbarWidth: 'none' },
  tab: { background: 'var(--border-soft)', border: '1px solid var(--border)', color: 'var(--text-dim)', borderRadius: '20px', padding: '7px 12px', fontSize: '10px', fontWeight: '800', letterSpacing: '0.5px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', whiteSpace: 'nowrap', fontFamily: '"Inter", sans-serif', flexShrink: 0 },
  tabActiv: { background: 'rgba(0,229,255,0.08)', border: '1px solid rgba(0,229,255,0.25)', color: 'var(--accent)' },
  ...
  golCard: { backgroundColor: 'var(--surface-2)', border: '1px solid var(--border-soft)', borderRadius: '14px', padding: '40px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', textAlign: 'center', marginTop: '20px' },
  golTitlu: { margin: 0, fontSize: '16px', fontWeight: '800', color: 'var(--text-strong)' },
  golText: { margin: 0, fontSize: '13px', color: 'var(--text-faint)', lineHeight: '1.5' },
  card: { backgroundColor: 'var(--surface-2)', borderRadius: '12px', padding: '14px', border: '1px solid var(--border-soft)', display: 'flex', flexDirection: 'column', gap: '8px' },
  ...
  cardTip: { margin: 0, fontWeight: '700', fontSize: '14px', color: 'var(--text-strong)' },
  cardTipBadge: { fontSize: '8px', fontWeight: '800', color: 'var(--text-faint)', backgroundColor: 'var(--border-soft)', padding: '2px 6px', borderRadius: '6px', letterSpacing: '0.5px' },
  cardVehicul: { margin: 0, fontSize: '11px', color: 'var(--text-dim)', fontWeight: '600', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  tag: { fontSize: '9px', fontWeight: '800', padding: '4px 9px', borderRadius: '20px', letterSpacing: '0.5px', flexShrink: 0, whiteSpace: 'nowrap' },
  cardMesaj: { margin: 0, fontSize: '12px', color: 'var(--text-muted)', lineHeight: '1.5' },
  cardData: { margin: 0, fontSize: '11px', color: 'var(--text-faint)', fontWeight: '600' },
  cardActiuni: { display: 'flex', gap: '8px', marginTop: '2px' },
  btnVezi: { flex: 1, backgroundColor: 'rgba(0,229,255,0.06)', border: '1px solid rgba(0,229,255,0.18)', color: 'var(--accent)', borderRadius: '8px', padding: '9px', fontSize: '10px', fontWeight: '800', letterSpacing: '0.5px', cursor: 'pointer', fontFamily: '"Inter", sans-serif' },
  ...
  modal: { background: 'linear-gradient(180deg, var(--surface) 0%, var(--bg) 100%)', width: '100%', maxWidth: '500px', padding: '24px 20px', borderRadius: '20px 20px 0 0', border: '1px solid rgba(0,229,255,0.15)', borderBottom: 'none' },
  modalHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' },
  modalSub: { margin: '0 0 4px 0', fontSize: '9px', color: 'var(--accent)', fontWeight: '800', letterSpacing: '2px' },
  modalTitlu: { margin: 0, fontSize: '16px', fontWeight: '800', color: 'var(--text-strong)' },
  closeBtn: { background: 'var(--border)', border: '1px solid var(--border-strong)', color: 'var(--text-muted)', borderRadius: '8px', width: '32px', height: '32px', cursor: 'pointer', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontFamily: '"Inter", sans-serif' },
  modalDesc: { margin: '0 0 16px 0', fontSize: '13px', color: 'var(--text-dim)', lineHeight: '1.5' },
  fieldWrap: { display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '20px' },
  fieldLabel: { fontSize: '9px', color: 'var(--accent)', fontWeight: '800', letterSpacing: '1.5px' },
  dateInput: { backgroundColor: 'var(--bg)', border: '1px solid rgba(0,229,255,0.2)', padding: '13px 14px', borderRadius: '10px', color: 'var(--text)', fontSize: '15px', fontWeight: '600', fontFamily: '"Inter", sans-serif', colorScheme: 'dark', width: '100%', boxSizing: 'border-box' },
  modalActiuni: { display: 'flex', gap: '10px' },
  btnAnuleaza: { flex: 1, backgroundColor: 'var(--border-soft)', border: '1px solid var(--border)', color: 'var(--text-dim)', borderRadius: '10px', padding: '13px', fontSize: '11px', fontWeight: '800', letterSpacing: '0.5px', cursor: 'pointer', fontFamily: '"Inter", sans-serif' },
  btnSalveaza: { flex: 2, backgroundColor: 'var(--accent)', border: 'none', color: 'var(--accent-ink)', borderRadius: '10px', padding: '13px', fontSize: '11px', fontWeight: '800', letterSpacing: '0.5px', cursor: 'pointer', fontFamily: '"Inter", sans-serif' },
};
